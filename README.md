...
### This is no longer the exact Neovim config I use (see [my current dev-env](https://github.com/JackDerksen/macos-dev-env)), but I still think it's a good building block on top of LazyVim.
